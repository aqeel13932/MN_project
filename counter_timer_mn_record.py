...
parser.add_argument('--manipulation',type=str,default='1100110011001100',help='1 marks morning, 0 marks night. E.x 1000 means 1 morning, then 3 nights in arrow')
...
def TryModel(model,game):
    ...
    mn_counter=0
    half_night = args.night_length/2
